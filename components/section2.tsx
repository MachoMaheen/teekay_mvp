...
const Section2: NextPage = () => {
  return (
    <section className="self-stretch h-[323px] overflow-hidden shrink-0 flex flex-col items-center justify-start py-0 px-[375px] box-border relative max-w-full text-left text-sm text-iteck-gatsbyvercelapp-cornflower-blue font-iteck-gatsbyvercelapp-inter-regular-144">
          ...
          <div className="w-[1088px] flex flex-col items-start justify-start pt-[50px] px-0 pb-0 box-border max-w-full">
            <div className="self-stretch flex flex-row flex-wrap items-start justify-start py-0 pr-2.5 pl-0">
              ...
              <DivcolLg2
                ...
                hackProtection="Hack Protection"
                png="/38png@2x.png"
              />
              <DivcolLg2
